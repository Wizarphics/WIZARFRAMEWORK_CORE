...
class AskCli
{
     ...
     *
     * // Takes any input
     * $color = AskClI::prompt('What is your favorite color?');
     *
     * // Takes any input, but offers default
     * $color = AskClI::prompt('What is your favourite color?', 'white');
     *
     * // Will validate options with the in_list rule and accept only if one of the list
     * $color = AskClI::prompt('What is your favourite color?', array('red','blue'));
     *
     * // Do not provide options but requires a valid email
     * $email = AskClI::prompt('What is your email?', null, 'required|valid_email');
     *
    ...
    public static function promptByKey($text, array $options, $validation = null): string
    {
        ...
        foreach ($options as $key => $description) {
            ...
            AskClI::write(AskClI::color($name, 'green') . AskClI::wrap($description, 125, $keyMaxLength + 4));
        }
...
AskClI::init(); // @codeCoverageIgnore
